                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="about_content">
                            <div class="card" style="width: 100%;">
                                <div class="card-body">
                                    <h5 class="card-title">Please Fill These Form To Donate plasma.</h5>
                                    <h6 class="card-subtitle mb-2 text-muted">Thank you for your contribution</h6>
                                    {!!Form::model($plasmaDonar ?? '',[
                                        'method'=>'POST',
                                        'route' =>'plasma.donar.store',
                                        'files'=>true
                                    ])!!}
                                    @csrf
                                        <div class="form-group {{$errors->has('plasma_donar_name')?'has-error':''}}">
                                            <label for="plasma_donar_name">Name</label>
                                            <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="plasma_donar_name">
                                            @if($errors->has('plasma_donar_name'))
                                                <span class="help-block">{{$errors->first('plasma_donar_name')}}</span>
                                            @endif
                                        </div>
                                        <div class="form-group {{$errors->has('plasma_donar_email')?'has-error':''}}">
                                            <label for="plasma_donar_email">Email address</label>
                                            <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="plasma_donar_email">
                                            @if($errors->has('plasma_donar_email'))
                                                <span class="help-block">{{$errors->first('plasma_donar_email')}}</span>
                                            @endif
                                        </div>
                                        <div class="form-group {{$errors->has('plasma_donar_phone')?'has-error':''}}">
                                            <label for="phone">Phone Number</label>
                                            <input type="text" class="form-control" id="phone" name="plasma_donar_phone">
                                            @if($errors->has('plasma_donar_phone'))
                                                <span class="help-block">{{$errors->first('plasma_donar_phone')}}</span>
                                            @endif
                                        </div>
                                        <div class="form-group {{$errors->has('covid_verified')?'has-error':''}}">
                                            <label style="display: block">Covid positive Verified Image</label>
                                            <input type="file" class="form-control" id="covid_verified" name="covid_verified">
                                            <label for="covid_verified" style="padding:15px 30px;background:#000;color:#fff">Browse File</label>
                                            @if($errors->has('covid_verified'))
                                                <span class="help-block">{{$errors->first('covid_verified')}}</span>
                                            @endif
                                        </div>
                                        <div class="form-group {{$errors->has('covid_recovered')?'has-error':''}}">
                                            <label style="display: block">Covid positive Recovered Image</label>
                                            <input type="file" class="form-control" id="covid_recovered" name="covid_recovered">
                                            <label for="covid_recovered" style="padding:15px 30px;background:#000;color:#fff">Browse File</label>
                                            @if($errors->has('covid_recovered'))
                                                <span class="help-block">{{$errors->first('covid_recovered')}}</span>
                                            @endif
                                        </div>
                                        <div class="input-group mb-3 {{$errors->has('donar_blood_group')?'has-error':''}}">
                                            <div class="input-group-prepend">
                                                <label class="input-group-text" for="inputGroupSelect01">Options</label>
                                            </div>
                                            <select class="custom-select" id="inputGroupSelect01" name="donar_blood_group">
                                            ...
                                            @if($errors->has('donar_blood_group'))
                                                <span class="help-block">{{$errors->first('donar_blood_group')}}</span>
                                            @endif
                                        </div>
