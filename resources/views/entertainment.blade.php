                    ...
                    <div class="col-lg-12 d-flex">
                        <div class="content_box">
                            <ul class="bread_crumb text-center">
                                ...
                                <li class="bread_crumb-item active"> Entertainment</li>
                            </ul>
                            <h1>This playground is all yours</h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="list-group">
                            ...
                            <a href="{{route('snake')}}" class="list-group-item list-group-item-action">Snake Games</a>
                            <a href="{{route('word')}}" class="list-group-item list-group-item-action">Word Guesser</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="list-group">
                            ...
                            <a href="https://dl.bdebooks.com/Bangladeshi%20Writer/1.%20Humayun%20Ahmed/02%20Misir%20Ali%20Series/23%20Misir%20Ali%20Omnibus%203%20PDF%20book%20by%20Humayun%20Ahmed.pdf"
                               class="list-group-item list-group-item-action">Misir Ali Omnibus</a>
                            <a href="https://dl.bdebooks.com/Bangladeshi%20Writer/1.%20Humayun%20Ahmed/01%20Himu%20Series/27%20Himu%20Somogro%202%20By%20Humayun%20Ahmed.pdf"
